        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-10">
            ...
            <p className="text-lg md:text-xl text-slate-400 leading-relaxed max-w-3xl border-l-2 border-slate-700 pl-6">
              Vena adalah pembuluh darah yang membawa darah dari seluruh tubuh
              kembali ke jantung. Fungsi utamanya adalah mengembalikan darah
              yang telah mengandung banyak karbon dioksida (CO₂) dan sedikit
              oksigen (O₂) dari jaringan tubuh ke jantung untuk kemudian dipompa
              ke paru-paru.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            ...
            >
              ...
              <ul className="space-y-3 text-slate-400 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Dinding lebih tipis dibanding arteri dengan lapisan otot
                    sedikit.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-blue-500 shrink-0" />
                  <span>
                    Memiliki <strong>katup satu arah</strong> untuk mencegah
            ...
            >
              ...
              <ul className="space-y-3 text-slate-400 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>Membawa darah miskin oksigen kembali ke jantung.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-1.5 w-1.5 h-1.5 rounded-full bg-emerald-500 shrink-0" />
                  <span>
            ...
            <motion.div
              variants={itemVariants}
              className="bg-slate-900/50 backdrop-blur-sm border border-slate-800 p-6 rounded-2xl hover:border-slate-600 transition-colors md:col-span-2 lg:col-span-1 group"
            >
              ...
              <h3 className="text-xl font-bold text-white mb-3">Vena Utama</h3>
              <ul className="space-y-3 text-slate-400 text-sm">
                <li className="border-b border-slate-800/50 pb-2 last:border-0 last:pb-0">
                  <strong className="text-slate-200 block text-xs uppercase tracking-wide mb-1">
                    Cava Superior
                  </strong>
                  Membawa darah dari tubuh bagian atas ke atrium kanan.
                </li>
                <li className="border-b border-slate-800/50 pb-2 last:border-0 last:pb-0">
                  <strong className="text-slate-200 block text-xs uppercase tracking-wide mb-1">
                    Cava Inferior
                  </strong>
                  Membawa darah dari tubuh bagian bawah.
                </li>
                <li className="pb-2">
                  <strong className="text-slate-200 block text-xs uppercase tracking-wide mb-1">
                    Pulmonalis
                  </strong>
                  Membawa darah kaya O₂ dari paru ke jantung.
                </li>
              </ul>
            </motion.div>
          </div>
          ...
          <motion.div variants={itemVariants} className="w-full">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-xl">
              ...
              <div className="hidden md:grid grid-cols-12 bg-slate-800/50 border-b border-slate-700 text-sm font-semibold text-slate-300 uppercase tracking-wider">
                <div className="col-span-3 px-6 py-4">Gangguan</div>
              ...
              <div className="divide-y divide-slate-800">
                {[
                  {
                    gangguan: "Varises",
                    penyebab: "Katup vena melemah, darah menumpuk (refluks).",
                    dampak: "Pembuluh menonjol berkelok, nyeri kaki.",
                  },
                  {
                    gangguan: "Tromboflebitis",
                    penyebab: "Inflamasi akibat gumpalan darah (trombus).",
                    dampak: "Bengkak kemerahan, nyeri tekan lokal.",
                  },
                  {
                    gangguan: "Insufisiensi Vena",
                    penyebab: "Kegagalan katup menutup sempurna (kronis).",
                    dampak: "Edema (bengkak), perubahan warna kulit.",
                  },
                  {
                    gangguan: "Emboli Paru",
                    penyebab: "Lepasnya gumpalan darah menuju paru-paru.",
                    dampak: "Sesak napas mendadak, mengancam nyawa.",
                  },
                ].map((row, idx) => (
                  <div
                    key={idx}
